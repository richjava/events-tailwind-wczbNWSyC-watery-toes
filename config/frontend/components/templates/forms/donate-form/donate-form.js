                ...
                <div className="w-full lg:w-1/2 lg:mr-10">
                    ...
                    <div className="sm:mx-6 lg:mx-12">
                        ...
                        <div className="flex items-start mb-20">
                            ...
                            <div>
                                <h3 className="font-sans text-lg font-semibold mb-2">Bringing world-class musicians to Wanaka.</h3>
                                <p className="text-primary-50 leading-7">Enjoying live performances with friends and fellow music-lovers.</p>
                            </div>
                        </div>
                        <div className="flex items-start mb-20">
                            <div className="bg-secondary p-3 rounded-lg mr-8">
                            ...
                            <div>
                                <h3 className="font-sans text-lg font-semibold mb-2">Providing performers with the opportunity to share their talents with us.</h3>
                                <p className="text-primary-50 leading-7">Contributing to the culture of our local community.</p>
                            </div>
                        </div>
                        <div className="flex items-start mb-20">
                            <div className="bg-secondary p-3 rounded-lg mr-8">
                            ...
                            <div>
                                <h3 className="font-sans text-lg font-semibold mb-2">Enabling the Wanaka Concert Society to invite top performers to Wanaka.</h3>
                                <p className="text-primary-50 leading-7">Helping with the cost of publicity and other costs.</p>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="w-full lg:w-1/2 relative">
                    <div className="border shadow-lg rounded-lg bg-white p-5 md:p-10 lg:mt-48 xl:mt-64 mb-16" data-aos="fade-up" data-aos-duration="650" data-aos-once="true">
                        ...
                        <form id="donateForm">
                            <div className="form-group flex flex-col mb-5">
                                <label className="text-primary-60 mb-2" for="firstName">First name</label>
                                <input className="form-control px-4 py-3 border rounded" type="text" id="firstName" name="firstName" aria-describedby="firstName" placeholder="First name" required="required" />
                            </div>
                            <div className="form-group flex flex-col mb-5">
                                <label className="text-primary-60 mb-2" for="lastName">Last name</label>
                                <input className="form-control px-4 py-3 border rounded" type="text" id="lastName" name="lastName" aria-describedby="lastName" placeholder="Last name" required="required" />
                            </div>

                            <div className="form-group flex flex-col mb-5">
                                <label className="text-primary-60 mb-2" for="email">Donation amount (NZD)</label>
                                <input className="form-control px-4 py-3 border mb-2 rounded" type="number" id="donationAmount" name="donationAmount" aria-describedby="donationAmount" placeholder="Enter donation amount" step="10" required="required" />
                            </div>
                            <div className="form-group flex flex-col mb-5">
                                <label className="text-primary-60 mb-2" for="email">Email</label>
                                <input className="form-control px-4 py-3 border mb-2 rounded" type="email" id="email" name="email" aria-describedby="email" placeholder="Your email" required="required" />
                                <small id="emailHelp" className="form-text text-xs text-primary-50">We'll never share your email with anyone else.</small>
                            </div>
                            <div className="form-group flex flex-col mb-5">
                                <label className="text-primary-60 mb-2" for="phone">Cellphone number</label>
                                <input className="form-control px-4 py-3 border rounded" type="text" id="phone" name="phone" aria-describedby="phone" placeholder="Cellphone number" />
                            </div>
                            <label className="ohno" for="ohno"></label>
                            <input className="ohno" autocomplete="off" type="text" id="ohno" name="ohno" placeholder="Your ohno here" />

                            <button id="submitBtn" type="submit" className="submit-btn w-full py-4 text-white text-sm tracking-widest hover:text-white bg-secondary hover:bg-secondary-dark uppercase focus:outline-none focus:text-white focus:bg-secondary transition duration-200 ease-in-out">
                                <div className="spinner pb-4 hidden"></div>
                                <span className="label">Send</span></button>
                        </form>
                        <div className="donation-instructions hidden text-center mb-10">
                            <svg viewBox="0 0 123.32 114.07" width="120px" className="mx-auto mb-10">
                            ...
                            <div className="text-left">
                                ...
                                <p className="mb-5">To complete your donation, please use one of the following payment methods:</p>
                        ...
                        <div className="donation-error-msg hidden">
